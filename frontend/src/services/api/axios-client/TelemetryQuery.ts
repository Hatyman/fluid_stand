...
export function getListDefaultOptions(): UseQueryOptions<
  Types.Telemetry[],
  unknown,
  Types.Telemetry[]
> {
...
export function setListDefaultOptions(
  options: UseQueryOptions<Types.Telemetry[], unknown, Types.Telemetry[]>
) {
...
export function listQueryKey(...params: any[]): QueryKey {
  return trimArrayEnd(['TelemetryClient', 'list']);
}
function __list() {
  return Types.TelemetryClient.list();
}

export function useListQuery<TSelectData = Types.Telemetry[], TError = unknown>(
  options?: UseQueryOptions<Types.Telemetry[], TError, TSelectData>
...
export function setListData(
  ...
  updater: (data: Types.Telemetry[] | undefined) => Types.Telemetry[]
) {
  queryClient.setQueryData(listQueryKey(), updater);
}

export function setListDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: Types.Telemetry[] | undefined) => Types.Telemetry[]
) {
...
export function createMutationKey(): MutationKey {
  return trimArrayEnd(['TelemetryClient', 'create']);
}

export function useCreateMutation<TContext>(
  options?: Omit<
    UseMutationOptions<Types.Telemetry, unknown, Types.Telemetry, TContext>,
    'mutationKey' | 'mutationFn'
  >
): UseMutationResult<Types.Telemetry, unknown, Types.Telemetry, TContext> {
  const key = createMutationKey();

  const metaContext = useContext(QueryMetaContext);
  options = addMetaToOptions(options, metaContext);

  return useMutation((data: Types.Telemetry) => Types.TelemetryClient.create(data), {
    ...options,
    mutationKey: key,
  });
}
